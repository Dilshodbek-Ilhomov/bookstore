...
export const translations = {
  uz: {
    ...
    hero: {
      ...
      subtitle: "Minglab sara kitoblar — bir joyda. O'zingizga mos kitobni tez toping va butun O'zbekiston bo'ylab tez yetkazib olasiz.",
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: "Thousands of handpicked titles in one place. Find your perfect read and get it delivered anywhere in Uzbekistan.",
