...
export const translations = {
  uz: {
    ...
    hero: {
      ...
      title1: "Kitob o'qing,",
      title2: "dunyoingizni kengaytiring",
      subtitle: "Minglab sara kitoblar orasidan o'zingizga mosini tez va oson toping. Yetkazib berish butun O'zbekiston bo'ylab.",
  ...
  en: {
    ...
    hero: {
      ...
      bestseller: "Bestseller",
      title1: "Read Books,",
      title2: "Expand Your World",
      subtitle: "Discover your favorite books easily among thousands of titles. Fast delivery across all of Uzbekistan.",
