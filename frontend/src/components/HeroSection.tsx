        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] gap-12 lg:gap-10 items-center">
          ...
          >
            {loading ? (
              ...
              <>
                {/* Top Showcase Card */}
                <div className="group relative overflow-hidden rounded-3xl sm:rounded-[32px] border border-white/10 bg-navy-900/80 p-6 sm:p-7 shadow-[0_24px_48px_-12px_rgba(0,0,0,0.7),inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-md transition-all duration-500 hover:border-gold-400/35 hover:-translate-y-1">
                  <span className="sheen-overlay" aria-hidden="true" />
                  
                  <div className="flex items-start justify-between gap-4 mb-4">
                    <div className="flex items-center gap-3.5">
                      <div className="w-13 h-17 rounded-2xl bg-gradient-to-br from-gold-400/20 to-navy-800 flex items-center justify-center border border-gold-400/20 shrink-0 overflow-hidden relative shadow-md">
                        {topBook?.cover_image ? (
                          <img
                      ...
                      <div>
                        <span className="inline-flex items-center gap-1 text-[11px] font-mono uppercase tracking-wider text-gold-400 bg-gold-400/10 px-2.5 py-1 rounded-full mb-1">
                    ...
                    <div className="flex items-center gap-1 text-gold-400 font-mono font-bold text-sm bg-white/[0.04] px-3 py-1.5 rounded-full border border-white/5 shrink-0">
                  ...
                  <div className="flex items-center justify-between pt-3.5 border-t border-white/5">
                    ...
                    <Link
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-semibold text-gold-400 hover:text-gold-300 transition-colors bg-gold-400/10 px-3 py-1.5 rounded-full"
                    >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Link
                    ...
                    className="group relative overflow-hidden rounded-3xl border border-white/10 bg-navy-900/60 p-4 sm:p-5 shadow-lg transition-all duration-300 hover:border-white/20 hover:-translate-y-0.5 block"
                  >
                    <span className="sheen-overlay" aria-hidden="true" />
