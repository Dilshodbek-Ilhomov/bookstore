          ...
          >
            ...
            {items.length > 0 && (
              <div className="p-5 sm:p-6 border-t border-gold-400/20 bg-navy-950/95 backdrop-blur-xl space-y-4 shadow-[0_-10px_30px_rgba(0,0,0,0.6)] shrink-0">
                ...
                >
                  <div className="h-13 sm:h-14 w-full bg-navy-950/20 group-hover:bg-transparent transition-colors rounded-2xl flex items-center justify-center gap-2.5 font-bold tracking-wide text-navy-950 text-sm sm:text-base uppercase">
